...
<Aside type="caution">
These docs are for the v3 version of the package.

Documentation related to the v2 version and below is unavailable.
</Aside>
...
<Code code={"AuthKey_*.p8"} lang="env" title={".gitignore"} />
